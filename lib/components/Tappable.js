...
var Tappable = (function (_React$Component) {
  ...
  function Tappable(props) {
    ...
    _get(Object.getPrototypeOf(Tappable.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(Tappable, [{
    ...
    value: function render() {
      var classes = (0, _classnames2['default'])('tappable', {
    ...
    value: function handleTap() {
      if (this.props.onTap) this.props.onTap(this.props.score);
